...
import { FullMenuData, GalleryImagesData } from "../../../data/siteData";
              ...
              >
                ...
                <div className="w-full h-full absolute bg-black/40 top-full group-hover:top-0 duration-500 lg:p-12 md:p-8 p-3.5 flex flex-col items-start lg:gap-8 gap-4 justify-end">
                  ...
                  <div className="flex items-center justify-between w-full">
                    ...
                    <button className="text-white rounded-full bg-primary border duration-300 border-primary py-2 lg:px-6 md:px-4 px-3 hover:bg-primary/40 hover:backdrop-blur-xs md:text-base text-sm">
                      Learn More
                    </button>
                  </div>
                </div>
