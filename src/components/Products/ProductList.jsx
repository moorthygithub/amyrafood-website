          ...
          {products.map((item, index) => (
            <div className="hover:scale-105 transition duration-300 ease-in-out hover:cursor-pointer">
              <div
                ...
                className="group border border-primary/20 rounded-2xl p-6 hover:shadow-lg"
              >
                <div className="overflow-hidden rounded-xl mb-5">
                  <img
                    src={item.image}
                    alt={item.name}
                    className="w-full h-56 object-cover hover:scale-105 transition duration-300 ease-in-out hover:cursor-pointer"
                  />
                </div>
